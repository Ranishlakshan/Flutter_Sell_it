...
class SpecialFashion extends StatefulWidget {
  @override
  _SpecialFashionState createState() => _SpecialFashionState();
}

class _SpecialFashionState extends State<SpecialFashion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Fashion',style: TextStyle(letterSpacing: 2),),
        ...
        builder:  (context, snapshot) {
          if(!snapshot.hasData){
            ...
            for (int i = 0; i < snapshot.data.documents.length; i++){
              ...
              if (dbCatagory.contains('Fashion & Beauty')) {
