...
class SpecialEssentials extends StatefulWidget {
  @override
  _SpecialEssentialsState createState() => _SpecialEssentialsState();
}

class _SpecialEssentialsState extends State<SpecialEssentials> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Find Your Dream Vehicles',style: TextStyle(letterSpacing: 2),),
        ...
        builder:  (context, snapshot) {
          if(!snapshot.hasData){
            ...
            for (int i = 0; i < snapshot.data.documents.length; i++){
              ...
              if (dbCatagory.contains('Essentials')) {
