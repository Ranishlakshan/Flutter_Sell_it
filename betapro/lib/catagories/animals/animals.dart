...
class animalsForm extends StatefulWidget {
  ...
  const animalsForm({ this.cat1,this.cat2, this.globalKey}) ;

  //const animalsForm({Key key, this.globalKey}) : super(key: key);
  @override
...
class _animalsFormState extends State<animalsForm> {
  ...
  final _formKeyAnimals = GlobalKey<FormState>();
      ...
      postImage(imageFile).then((downloadUrl) {
        ...
        if(imageUrls.length==images.length){
          ...
          Firestore.instance.collection('ads').document(documnetID).setData({
            ...
            'reviewstatus':false,  
            'searchkey':itemname+","+widget.cat1+","+widget.cat2+"cats,dogs,birds",
            'value1':itemname,
            'value2':price,
            'value3':testLocation,
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyAnimals.currentState.validate() || loccc=='null'){
