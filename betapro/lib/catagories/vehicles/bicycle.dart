...
class bicycleForm extends StatefulWidget {
  ...
  const bicycleForm({ this.cat1,this.cat2, this.globalKey}) ;
  //const bicycleForm({Key key, this.globalKey}) : super(key: key);
  @override
...
class _bicycleFormState extends State<bicycleForm> {
  ...
  final _formKeyBicycle = GlobalKey<FormState>();
      ...
      postImage(imageFile).then((downloadUrl) {
        ...
        if(imageUrls.length==images.length){
          ...
          Firestore.instance.collection('ads').document(documnetID).setData({
            ...
            'reviewstatus':false,  
            'searchkey':carBrand+" "+carType+","+widget.cat1+","+widget.cat2,
            'value1':carBrand+" "+carType+" ",
            'value2':carPrice,
            'value3':testLocation,
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0  || !_formKeyBicycle.currentState.validate() || loccc=='null'  ){
