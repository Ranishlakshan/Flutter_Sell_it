...
class lorryForm extends StatefulWidget {
  //final GlobalKey<ScaffoldState> globalKey;
  final GlobalKey<ScaffoldState> globalKey;
  final String cat1,cat2;

  const lorryForm({ this.cat1,this.cat2, this.globalKey}) ;
  //const lorryForm({Key key, this.globalKey}) : super(key: key);
  @override
  _lorryFormState createState() => _lorryFormState();
}

class _lorryFormState extends State<lorryForm> {
  
  final _formKeyLorry = GlobalKey<FormState>();
