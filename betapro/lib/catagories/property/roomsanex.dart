...
class _roomanexFormState extends State<roomanexForm> {
  
  final _formKeyRoomAnex = GlobalKey<FormState>();
  ...
  String adname,beds,baths,houseSize,landSize,description,condition,price,phonenumbers,adtype;
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyRoomAnex.currentState.validate() || loccc=='null'){
