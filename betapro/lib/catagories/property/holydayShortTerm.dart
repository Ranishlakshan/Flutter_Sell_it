...
class _holidatShortTermFormState extends State<holidatShortTermForm> {
  
  final _formKeyHolidayShortTerm = GlobalKey<FormState>();
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyHolidayShortTerm.currentState.validate() || loccc=='null' ){
