...
class apartmentsForm extends StatefulWidget {
  ...
  const apartmentsForm({Key key, this.globalKey}) : super(key: key);
  @override
  _apartmentsFormState createState() => _apartmentsFormState();
}

class _apartmentsFormState extends State<apartmentsForm> {
  
  final _formKeyApartments = GlobalKey<FormState>();
  ...
  String adname,beds,baths,houseSize,landSize,description,condition,price,phonenumbers;
      ...
      postImage(imageFile).then((downloadUrl) {
        ...
        if(imageUrls.length==images.length){
          ...
          Firestore.instance.collection('ads').document(documnetID).setData({
            ...
            'reviewstatus':false,  
            'searchkey':adname+"propertyApartmentsapartments",
            'value1':adname,
            'value2':price,
            'value3':testLocation,
            'value4':DateTime.now().toString().substring(0, DateTime.now().toString().length - 10 ),
            //
            'category':"Apartments,Property",
        ...
        child: Column(children: <Widget>[
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'Enter Size of the House',
              labelText: 'House Size(Perches)',
              prefixIcon: Icon(Icons.add_circle)
            ),
          ),
          SizedBox(height: 20.0),
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'Enter Size of Land',
              labelText: 'Size of Land(Perches)',
              prefixIcon: Icon(Icons.add_circle)
            ),
          ),
          SizedBox(height: 20.0),
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0  || !_formKeyApartments.currentState.validate() || loccc=='null'){
