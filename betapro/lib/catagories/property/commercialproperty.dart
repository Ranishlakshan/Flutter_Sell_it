...
class _commercialPropertyFormState extends State<commercialPropertyForm> {
  ...
  final _formKeyCommercialProperty = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      child: Form(
        ...
        key: _formKeyCommercialProperty,
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyCommercialProperty.currentState.validate() || loccc=='null'){
