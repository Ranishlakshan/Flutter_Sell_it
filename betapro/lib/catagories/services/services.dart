...
class servicesForm extends StatefulWidget {
  ...
  const servicesForm({ this.cat1,this.cat2, this.globalKey}) ;

  //const servicesForm({Key key, this.globalKey}) : super(key: key);
  @override
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyService.currentState.validate() || loccc=='null'){
