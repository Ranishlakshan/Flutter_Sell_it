...
class homeAndGardenForm extends StatefulWidget {
  final GlobalKey<ScaffoldState> globalKey;
  final String cat1,cat2;

  const homeAndGardenForm({ this.cat1,this.cat2, this.globalKey}) ;

  //const homeAndGardenForm({Key key, this.globalKey}) : super(key: key);
  @override
  _homeAndGardenFormState createState() => _homeAndGardenFormState();
}

class _homeAndGardenFormState extends State<homeAndGardenForm> {
  
  final _formKeyHomeANDGarden = GlobalKey<FormState>();
