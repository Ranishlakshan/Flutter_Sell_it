...
class agriForm extends StatefulWidget {
  final GlobalKey<ScaffoldState> globalKey;
  final String cat1,cat2;

  const agriForm({ this.cat1,this.cat2, this.globalKey}) ;

  //const agriForm({Key key, this.globalKey}) : super(key: key);
  @override
  _agriFormState createState() => _agriFormState();
}

class _agriFormState extends State<agriForm> {
  
  final _formKeyAgri = GlobalKey<FormState>();
          ...
          RaisedButton(
              ...
              onPressed: () {
                String loccc = '${loccz.getdistrictName()}';
                 if(images.length==0 || !_formKeyAgri.currentState.validate() || loccc=='null'){
